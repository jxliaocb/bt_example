...
spy = bt.feeds.PandasData(
    dataname=yf.download(tickers='SPY', start=datetime(2012, 2, 28), end=datetime(2018, 2, 28)))
...
sharperatio = results[0].analyzers.sharperatio.get_analysis()
print(
    f"Sharpe: {sharperatio['sharperatio']}")
print(
